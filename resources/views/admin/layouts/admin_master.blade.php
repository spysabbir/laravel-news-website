...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="{{ asset('admin') }}/plagins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('admin') }}/plagins/fontawesome/css/all.min.css">
...
<body>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown d-flex">
                                <a class="nav-link d-flex mt-2" href="{{ route('admin.profile') }}">
                                    <div class="avatar avatar-online mx-3">
                                        <img src="{{ asset('uploads/profile_photo') }}/{{ Auth::guard('admin')->user()->profile_photo }}" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                            <div class="mb-2 mb-md-0">
                                ...
                                <a href="{{ env('APP_URL') }}" target="_blank" class="footer-link fw-bolder">{{ env('APP_NAME') }}</a>
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
    ...
    <!-- Core JS -->
    <script src="{{ asset('admin') }}/plagins/jquery/jquery-3.6.3.min.js"></script>
